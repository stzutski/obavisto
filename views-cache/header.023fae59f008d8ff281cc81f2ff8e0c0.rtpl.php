            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <ul class="cart-dropdown chat-dropdown onhover-show-div">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3 img-60" src="res/assets/images/ecommerce/02.jpg" alt="">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3 img-60" src="res/assets/images/ecommerce/08.jpg" alt="">
                      <div class="media-body"><span>Girls's T-shirt</span>
                        <p>It is a long established fact that a reader</p>
              ...
              <li class="onhover-dropdown"><i data-feather="message-square"></i>
                <ul class="chat-dropdown onhover-show-div">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3" src="res/assets/images/user/1.jpg" alt="">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3" src="res/assets/images/user/2.jpg" alt="">
                      <div class="status-circle online"></div>
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3" src="res/assets/images/user/4.jpg" alt="">
