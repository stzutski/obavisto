  ...
  <div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-header">
      <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper">
          <div class="logo-wrapper"><a href=""><img class="img-fluid" src="res/assets/images/logo/logo.png" alt=""></a>
          </div>
          ...
          <ul class="nav-menus">
            ...
            <li class="onhover-dropdown"><i data-feather="message-square"></i>
              <ul class="chat-dropdown onhover-show-div">
                ...
                <li>
                  <div class="media"><img class="img-fluid rounded-circle mr-3" src="res/assets/images/user/1.jpg"
                      alt="">
                ...
                <li>
                  <div class="media"><img class="img-fluid rounded-circle mr-3" src="res/assets/images/user/2.jpg"
                      alt="">
                    <div class="status-circle online"></div>
                ...
                <li>
                  <div class="media"><img class="img-fluid rounded-circle mr-3" src="res/assets/images/user/4.jpg"
                      alt="">
    ...
    <div class="page-body-wrapper horizontal-menu">
      ...
      <div class="sidebar-wrapper">
        <div class="logo-wrapper"><a href="<?php echo htmlspecialchars( $urlApp, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img class="img-fluid" src="res/assets/images/logo/logo.png"
              alt=""></a></div>
        <div class="logo-icon-wrapper"><a href="<?php echo htmlspecialchars( $urlApp, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img class="img-fluid"
              src="res/assets/images/logo/logo-icon.png" alt=""></a></div>
        <nav>
            ...
            <div id="sidebar-menu">
              ...
              <ul class="sidebar-links custom-scrollbar">
                <li class="back-btn"><a href="index.html"><img class="img-fluid"
                      src="res/assets/images/logo/logo-icon.png" alt=""></a>
                  <div class="mobile-back text-right"><span>Back</span><i class="fa fa-angle-right pl-2"
                      aria-hidden="true"></i></div>
                </li>

                <?php if( $NAVLEVEL == 'cliente' ){ ?>

                <?php require $this->checkTemplate("menu-lateral-cliente");?>

                <?php } ?>


                <?php if( $NAVLEVEL == 'master' ){ ?>

                <?php require $this->checkTemplate("menu-lateral-master");?>

                <?php } ?>


                <?php if( $NAVLEVEL == 'admin' ){ ?>

                <?php require $this->checkTemplate("menu-lateral-admin");?>
