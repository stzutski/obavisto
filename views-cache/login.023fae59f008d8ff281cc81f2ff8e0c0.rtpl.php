...
<html lang="en">
  <head>
    ...
    <title>Obavisto - Login de Acesso</title>
    <!-- Google font-->
      ...
      <div class="row">
        <div class="col-12">     
          <div class="login-card">
            <div>
              <div><a class="logo" href="http://localhost/labs/obavisto/"><img class="img-fluid for-light" src="res/assets/images/logo/logo-login.png" alt="looginpage"><img class="img-fluid for-dark" src="res/assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
              <div class="login-main"> 
                <form class="theme-form" method="POST" action="http://localhost/labs/obavisto/">
                  <h4>Sign in to account</h4>
                  <p>Enter your email & password to login</p>
                  <div class="form-group">
                    <label class="col-form-label">Email Address</label>
                    <input class="form-control" type="text" required="" name="userlogin">
                  </div>
                  <div class="form-group">
                    <label class="col-form-label">Password</label>
                    <input class="form-control" type="password" name="pwdlogin" required="">
