              ...
              <div class="login-main">
                <form class="theme-form" method="POST" action="<?php echo htmlspecialchars( $urlFormLogin, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                  ...
                  <div class="form-group mb-0">
                    ...
                    </div><a class="link" href="<?php echo htmlspecialchars( $urlPwdRecovery, ENT_COMPAT, 'UTF-8', FALSE ); ?>">Esqueceu a senha?</a>
                  ...
                  <p class="mt-4 mb-0">Novo usuário?<a class="ml-2" href="<?php echo htmlspecialchars( $urlFormCadastro, ENT_COMPAT, 'UTF-8', FALSE ); ?>">criei sua conta grátis</a></p>
                </form>
              </div>
            </div>
          </div>
