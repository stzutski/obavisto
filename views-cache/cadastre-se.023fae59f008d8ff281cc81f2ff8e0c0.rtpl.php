                ...
                <form class="theme-form">
                  ...
                  <div class="form-group mb-0">
                    <div class="checkbox p-0">
                      ...
                      <label class="text-muted" for="checkbox1">Concordo: <a class="ml-2" href="#">Política de Privacidade</a></label>
                    </div>
                  ...
                  <p class="mt-4 mb-0">Já cadastrado?<a class="ml-2" href="login">Acessar</a></p>
                </form>
              </div>
            </div>
          </div>
